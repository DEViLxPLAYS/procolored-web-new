    ...
    <ConsumableProduct
      data={{
        ...
        details: {
          ...
          description: `Applicable to: smooth and adhesion-supportive surface
Feature: presenting silvery effect; proper thickness and hardness, self-adhesive, durable, anti-ultraviolet/high temperature/water/abrasion, easy separation/operation/application, outstanding color reproduction, high-quality 3D effect`,
          compatibility: `Compatible printer: Compatible with UVDTF printers of A3 printing size, including VF13 Pro printer.`,
          technical: `Substrate: PET with silver coating
