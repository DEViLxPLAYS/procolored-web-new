...
export default function PreSalesConsult() {
  return (
    <div className="w-full bg-[#f9f9f9] min-h-screen pt-12 pb-24 font-sans text-[#1a1a1a]">
      <div className="max-w-7xl mx-auto px-4">
        <h1 className="text-[28px] font-bold mb-10 text-[#1a1a1a]">Pre-Sales Consult</h1>
          ...
          <div className="flex-1 bg-white p-8 md:p-12 rounded-lg shadow-sm">
            ...
            <div className="mb-8">
              ...
              <p className="text-[#666666] text-sm">
                Leave a message if you have any question about choosing products and we'll get back to you shortly.
              </p>
            </div>
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <textarea rows={5} placeholder="Please provide details about what you're looking for." className="w-full border border-gray-300 rounded-md px-4 py-3 text-sm focus:outline-none focus:border-red-500 transition-colors resize-y"></textarea>
              </div>

              <div>
                <label className="block text-sm font-bold text-[#1a1a1a] mb-2">The Product You Are Interested In</label>
                <input type="text" placeholder="Product link" className="w-full border border-gray-300 rounded-md px-4 py-2.5 text-sm focus:outline-none focus:border-red-500 transition-colors" />
              </div>
