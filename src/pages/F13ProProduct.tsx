...
export default function F13ProProduct() {
  ...
  const finalPrice = variant.sale + (stand === 1 ? 200 : 0);
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {['Without Stand', 'Stand (+$200)'].map((label, i) => (
                  <button key={i} onClick={() => setStand(i)}
                    className={`py-3 px-4 rounded-xl border-2 font-semibold text-sm transition-all ${stand === i ? 'border-orange-500 text-orange-600 bg-orange-50' : 'border-gray-200 text-gray-700 hover:border-gray-300'}`}>
                    {label}
                  </button>
                ))}
              </div>
            ...
            <div className="flex flex-wrap gap-4 text-sm font-medium text-gray-700 pt-1">
              ...
              <span className="flex items-center gap-1"><Zap className="w-4 h-4 text-orange-500" />3–7 Days Fast Delivery</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-1">
              ...
              <button onClick={() => addToCart({ id: variant.id + '-' + stand, name: `${variant.name} (${stand === 0 ? 'Without Stand' : 'Stand'})`, price: `$USD:${finalPrice}`, image: variant.img, quantity: qty })}
              ...
              <button onClick={() => {
                addToCart({ id: variant.id + '-' + stand, name: `${variant.name} (${stand === 0 ? 'Without Stand' : 'Stand'})`, price: `$USD:${finalPrice}`, image: variant.img, quantity: qty });
