  ...
  return (
    <ConsumableProduct
      data={{
        ...
        infoSections: [
          { label: 'Outlined', content: `Covered with chameleon coating, presenting printings with brighter and silky colors, as well as impressive glossiness` },
...
Feature: covered with chameleon coating, presenting printings with brighter and silky colors, as well as impressive glossiness; good hand feel; strong ink absorption, anti-powder adhesion , easy separation` },
          ...
          { label: 'Technical Specification', content: `Substrate: PET with chameleon coating
Thickness: 0.1mm
