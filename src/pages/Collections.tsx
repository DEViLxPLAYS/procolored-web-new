...
export default function Collections() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return [...unfiltered].sort((a: any, b: any) => {
      ...
      const newIds = ['47', 'garment-jig-dtg', 'gift-card', 'dtf-powder', 'dtf-ink-250ml', 'uv-white-ink-500ml', 'uvdtf-white-ink-500ml', 'uvdtf-ink-500ml', 'nozzle-protection-liquid', 'dtf-cleaner-ink', 'cleaning-kits', 'uv-cleaner-ink', 'adhesion-promoter', 'uv-varnish-ink', 'uv-printer-ink-500ml', 'dtf-gilt-veil-transfer-film', 'dtf-chameleon-transfer-film', 'dtf-luminous-transfer-film', 'dtf-glitter-transfer-film', 'uvdtf-hot-stamping-sliver-film', 'dtf-pretreat-transfer-film', 'dtf-pretreat-roll-13inch', 'dtf-pretreat-sheet-a4', 'uvdtf-hot-stamping-gold-film', 'uvdtf-clear-ab-film', 'dtf-pretreat-roll-8inch', 'dtf-pretreat-sheet-a3', 'transfer-ab-film-uv-laminator', 'printhead-moisturizing-device', 'printer-ink-carriage-dtf', 'printer-motherboard', 'printer-cartridges-12pcs', 'white-ink-circulation-pump', 'remote-expert-service', 'film-holder-13inch', 'oven-heating-plate', 'ink-waste-pump-oven', 'oven-temperature-controller', 'extended-warranty-service', 'power-socket-switch', 'printer-ink-tank', 'printer-ink-tank-agitator', 'printhead-capping-unit', 'oven-exhaust-gas-filter', 'printer-control-board', 'printer-power-board', 'printhead-driver-board', 'printer-startup-button-board', 'printer-switching-power-supply', 'f13-multifunctional-board', 'printer-lease-f8-with-oven', 'deposit-f8-with-oven', 'printer-lease-f8-no-oven', 'deposit-f8-no-oven', 'panda-doll'];
